...
/*
 * File: /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk/System/Library/Frameworks/CoreTelephony.framework/CoreTelephony
 * UUID: 7CB3680D-B3BB-36A0-B59B-6D8E8CECF374
 * Arch: arm v7 (armv7)
 *       Current version: 1259.20.0, Compatibility version: 1.0.0
...
{
    NSObject<CTMessageAddress> *_sender;
...
@property(copy, nonatomic) NSObject<CTMessageAddress> *sender; // @synthesize sender=_sender;
